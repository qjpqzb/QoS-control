...
def blob_detection(fname,timestep,initial_timestep):
    ...
    image.append(cv2.imread("xgc/70_120_nyquist_xgc/70_120_25/original.png"))
    ...
    for i in range(len(image)):
        ...
        if i ==1:
            if timestep!=initial_timestep:
                fp = np.load("xgc/70_150_nyquist_xgc/70_150_35/blob.npz")
            ...
            np.savez("xgc/70_150_nyquist_xgc/70_150_35/blob.npz", blob_number = blob_number, blob_diameter = blob_diameter, blob_area = blob_area, overlap_ratio = overlap_ratio)
            print "blob_number = ", blob_number
            print "blob_diameter = ", blob_diameter
            print "blob_area = ", blob_area
            print "overlap_ratio = ", overlap_ratio 
        plt.savefig("xgc/70_150_nyquist_xgc/70_150_35/blobed/xgc_70_150_"+str(timestep)+'_1_blobed.pdf', dpi=600,format='pdf')
...
for i in range(initial_timestep, 1201, time_interval):
    ...
    fname_head ="xgc/70_120_nyquist_xgc/70_120_55/xgc_70_120_"+str(i)+"_1"
    print fname_head
    ...
    fname_psnr = "xgc/70_120_nyquist_xgc/70_120_55/psnr.npz"
