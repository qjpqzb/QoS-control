...
int main (int argc, char ** argv) 
{
    ...
    for (step = 0; step < 1; step++)
    {
        ...
        sprintf (fname, "larger_data/astro2D.bp");
        //sprintf (fname, "/home/cephuser/ADIOS/examples/C/global-array/larger_data/128X_data/xgc.3d.08000.bp");
        printf("dodosada=%f\n",1e10);
...
//    printf ("\n");
        ...
        // read mesh
        adios_read_init_method (method, comm, "verbose=3");
        //ADIOS_FILE * fmesh = adios_read_open_file ("/home/cephuser/ADIOS/examples/C/global-array/larger_data/128X_data/xgc.mesh.bp", method, comm);
        ADIOS_FILE * fmesh = adios_read_open_file ("larger_data/astro2D.mesh.bp", method, comm);
